...
//:정의된 객체를 기반으로 생선된 다를 객체들이 공통적으로 사용할 수 있는 속성과 메소드를 제공

//?프로토타입 체인
//:프로토타입은 해당 객체의 상위 객체로부터 메소드와 속성을 상속받을 수 있음
//:다른 객체에 정의된 메소드와 속성을 한 객체에서 사용가능

//! 생성자 함수를 사용한 객체 생성
//:생성자 함수를 사용할 경우 코드를 재사용하여 같은 구조의 객체를 여러 개 생성가능
...
console.log(Object.prototype); //지원하는 기능

//! Object.create()를 사용한 객체 생성방법
//:create() 메소드는 프로토타입을 설정할 수 있는 새로운 객체 생성방법
...
//기존의 프로토타입 기반 상속보다 더 직관적인 방식으로 객체를 생성하고 상속가능
