...
//!1. 자바스크립트의 '원시 타입'과 '참조 타입'을
//>>'기본 자료형'과 '객체 자료형'으로 구분
...
console.log(typeof g); //number new를 사용하지 않으면 object x
...
//!3. 프로토타입으로 메소드 추가
//숫자 객체 전체에 어떤 속성과 메소드를 추가 가능하다면, 기본 자료형 숫자도 속성과 메소드를 사용가능
//:어떤 객체의 prototype이라는 속성이 객체 전용 틀
//:, prototype객체에 속성과 메소드를 추가하면 모든 객체(+ 기본 자료형)에서도 해당 속성과 메소드를 사용가능
...
//::객채 내부에서 값을 꺼내 쓰는 것임을 명확하게 전달하기 위해서 valueOf()를 사용
