...
//이벤트 객체인 'e'를 함수에 포함하고
//, 이벤트 객체의 target프로퍼티를 사용하여
//, 이벤트가 일어나는 버튼에 이벤트를 실행
function bgChange(e) {
...
const tileset = document.querySelectorAll('div');
...
form.onsubmit = function(e) {
  if(fname.value === '' || email.value === '') {
    //기본 행동을 방지하는 메소드
    e.preventDefault();
    para.textContnet = 'You need to fill in both name and email';
  };
};
