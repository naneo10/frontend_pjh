//자바스크립트 내장 객체(Built-in-Objects) Built-in: 내장되어있는
...
let num = 123.456789;
console.log(num.toFixed(3)); //끝자리는 반올림
...
//:배열의 각 요소를 반복하여 split()메소드로 나누어 새로운 배열로 반환 ('forEach', 'Map', 'filter')
...
//?3) length 메소드
//:문자열 길이를 반환
//:공백(띄어쓰기, 줄 바꿈도 한 개의 문자열로 인식)
let stringC = ' hellow, JS ';
