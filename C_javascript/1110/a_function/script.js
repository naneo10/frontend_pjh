...
function factorial(num) {
  ...
  if (num == 0) return 1; //타입계산 input창에서 값을 가져오기에(문자값이 됨) '==='을 사용하지 않음 사용시 자동으로 false값이 됨
...
input.addEventListener('change', () => {
  ...
  if (isNaN(num)) {
    ...
    para.innerHTML += `${num} factorial is ${factorial(num)}.<br />`;
  }
})