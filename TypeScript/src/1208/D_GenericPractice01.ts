{
  //!제네릭, 클래스, 배열 메서드를 이용한 회원관리 프로그램 구현
  ...
  //^회원관리 기능을 제공하는 Membership 클래스 정의
  //:제네릭을 사용하여 정의
  //:Member 객체의 리스트를 관리
  ...
  membership.addMember(new Member("ldk", 30));
  ...
  //   Member { name: 'ldk', age: 30, active: true },
