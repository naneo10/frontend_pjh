{
  ...
  //*이전 수업들은 자바에서도 구현 가능, 지금부터는 타입스크립트에서만 구현
  //?1.제네릭 정의
  ...
  //*이전 까지 하나의 타입만 가졌다면 제네릭을 사용 시 다양한 타입 활용 가능
  //-타입 안정성을 보장
  //:컴파일 시점에 타입을 체크
  ...
  //?3.제네릭의 기본 문법
  //:사용할 컴포넌트의 이름 뒤에 꺽쇠 갈호(< > 부등호) 안에 타입 변수를 넣는 것
  ...
  let stringOutput = generic<string>("stric generic");
  let numberOutput = generic<number>(500);
  console.log(stringOutput); //stric generic
