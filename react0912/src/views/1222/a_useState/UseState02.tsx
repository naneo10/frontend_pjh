...
//React의 이벤트 핸들러
//:onClick과 같이 'camelCate'를 사용
//:문자열이 아닌 함수를 '이벤트'에 전달

//?useState와 이벤트 처리의 결합
//사용자의 액션(버튼 클릭, 폼 제출 등)에 따라서 상태를 변경
//이벤트 헨들러 내에서 useState 상태 업데이트 함수를 호출하여 상태를 변경
  ...
  return(
    <>
      {/* 
        ...
        onChange 이벤트
        :사용자가 입력 필드에 타이핑 할 때마다 발생한느 이벤트
        :input, textarea, select 등의 HTML요소에 적용
      */}
      <h5>useState를 사용한 이벤트 처리</h5>
