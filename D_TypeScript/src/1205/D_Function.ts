{
  ...
  console.log(select());
  console.log(select("hellow")); //hihellow
  console.log(select("hellow", "lsa")); //las hello

  //선택적 매개변수와 기본 매개변수의 차이
  //두 가지 모두 함수 호출 시 생략 가능 (오류발생x)
  ...
  //* function add(a: any, b: any, c: any): any {} 함수의 구현 자체는 한 번만
