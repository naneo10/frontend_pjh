...
//(==, !=, ===, !==, <, >, <=, >=)
//리턴 값(결과 값)은 boolean타입(ture, false)
...
//switch문은 여러가지 가능한 케이스 중 하나를 선택하여
...
//주어진 조건을 평가한 후
//, 그 결과가 ture면 표현식1을, false면 표현식2를 실행
...
true || alert('출력A'); //A //true건 false건 ture로 출력
true && alert('출력A'); //출력 x /&&뒤의 값 인식X
