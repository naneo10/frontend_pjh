/*
  ! 자료형(Data Type)
    :기본 자료형(string, number, boolean, null & undefinded)
    :자료형 검사
    :자료형 변환
*/
...
//-어떤 값과도 동등하지 'X'
//  NaN === NaN (X)
//-연산에서 전파: 어떤 수확의 연산도 NaN과 만나면 결과 값이 NaN
...
let stringToBoolean = Boolean('hellow');
