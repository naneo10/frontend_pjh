...
//?1.&& 연산자
//:a와 b중에 모두 true여야만 true를 반환
//:어느 하나라도 false인 경우 false 반환
//-a && b에서 a값이 false인 경우 b의 값을 계산 x

//a 쿠키(회원정보가 있을 경우 true, 없을 경우 false)
//b 모든 회원이 접근 가능 / 회원만 접근할 수 있는 페이지

//a가 false라면(회원이 아니라면) >> 회원만 접근할 수 있는 페이지 렌더링 x

age = 10;
if (age !== null) {
  console.log("값이 있을 경우 ture");
}
...
//?2.|| 연산자
//:a와 b중 어느 하나라도 참인 경우 무조건 참인 결과를 반환
//a || b 
...
//true || "A"
//:또는
//:true 또는 "A"가 존재한다면 실행
//:ture가 한 개 이상이면 더 이상 다른 값들은 의미가 x
