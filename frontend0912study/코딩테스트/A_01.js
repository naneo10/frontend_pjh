...
//'2022년 08월 20일'부분을 추출
const redTextSlice = str.slice(4, 17); //slice(시작위치-포함o, 종료위치-포함x)
console.log(redTextSlice);

//?substring 사용방법
const redTextSubstring = str.substring(4, 17); //substring
//slice(시작위치-포함o, 종료위치-포함x)
...
//slice는 자유롭게 사용 가능
//:뒤에서부터 문자열을 자를때 사용 (4, -4)

//substring은 음수를 대입하는 경우 해당 값이 0으로 치환되어 사용
...
//두 배열을 합치기
let combinedArr = [...arr1, ...arr2]; //[ 3, 4, 5, 9, 6, 2 ]
...
//filter메소드
//:매개변수 (value(현재 요소 값), index(현재 인덱스 번호), self)
