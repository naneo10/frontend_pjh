//?1.템플릿 문자열
//:문자열 내에 변수와 표현식을 쉽게 작성, 멀티라인 표현식을 간편하게 작성 //*백틱(``)
const multiList = `
  안녕하세요
  반갑습니다`;
...
const person = { name: "las", age: 28, height: 169, gender: "female" };
...
//b.스프레드 연산자
//:배열이나 객체의 요소를 쉽게 복사하거나 할칠 수 있는 연산자
const arr1 = [1, 2, 3];
// const arr2 = arr1;
const arr2 = [...arr1];
arr2[1] = 5;

//배열을 할당하여 복사하는 경우 주소 값이 복사되기 때문에
//, 복사된 배열을 수정하면 기존 배열 또한 똑같이 수정
//:스프레드 연산자로 복사를 하는 경우 요소값 만을 새로운 배열에 할당
console.log(arr1);
...
//-Promise
//:비동기 작업의 최종 완료 또는 실패를 나타내는 객체 //*함수 인자를 받게 됨
