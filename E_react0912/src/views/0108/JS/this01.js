...
let user = {
  ...
  greet: function() {
    //this.name은 user객체의 name 프로퍼티를 참조(user.name)
...
//1.call():첫 번째 인자로 this값을 설정, 이후의 인자들은 호출될 함수의 인자로 전달
...
function introduce2(name, profession) {
  console.log("내 이름은 " + this.name + "이고, 직업은 " + this.profession + "입니다.");
}
...
//!생성자 함수의 this
//:생성자 함수: new 키워드와 함께 사용, 새로운 객첼르 생성
